...
<div class="container">
    %if (page_config.get('vip_only', False) is True and vips is not UNDEFINED and username is not None and vips.get(username, None)==password) or ( page_config.get('vip_only', False) is False and (( page_config.get('password', UNDEFINED) is UNDEFINED and password is UNDEFINED) or password==page_config['password'])):
        <div style="max-width: ${page_config.get('max_stream_width', 99999)}px;" class="video-container">
            ...
            %if active_page == "/":
                <div class="below" style="max-width: ${page_config.get('max_stream_width', 99999)}px;">
                    ...
                    <div data-tab="teamstats" style="display:none; height: auto;">
                        <div style="padding: 5px 10px;">Available at the start of the 2016 regular season.</div>
        ...
        <div class="chat-container">
            %if active_page == "/vip":
                <script id="cid0020000090554645135" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js"
                        style="width: 350px;height: 700px;">{
                    "handle"
                :
                    "handysprivatechat", "arch"
                :
                    "js", "styles"
                :
                    {
    ...
    %else:
        <form style="padding: 0 20px;" class="pw_form" action="" method="post">
            %if page_config.get('vip_only', False) is True:
